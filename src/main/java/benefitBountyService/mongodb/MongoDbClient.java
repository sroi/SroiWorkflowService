...
public class MongoDbClient {
    ...
    private final MongoClient mongoClient = new MongoClient(new MongoClientURI(connectionString));
    private final MongoDatabase mongoDatabase;
    CodecRegistry pojoCodecRegistry = CodecRegistries.fromRegistries(MongoClientSettings.getDefaultCodecRegistry(),
            CodecRegistries.fromProviders(PojoCodecProvider.builder().conventions(Conventions.DEFAULT_CONVENTIONS).automatic(true).build())
    );
